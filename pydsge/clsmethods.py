...
def mcmc_summary(
    ...
    **args
    ...
    return ew.mcmc_summary(chain[-tune:], lprobs[-tune:], priors=self.priors, prior_transform=self.bptrans, acceptance_fraction=self.get_chain(get_acceptance_fraction=True), **args)
